...
Point(1006) = { -xwall, 0, 0, hc};
Point(1007) = { xwall, 0, 0, hc};
Point(1008) = { -xwall, blt, 0, 5*hc};
Point(1009) = { xwall, blt, 0, 5*hc };
...
Line Loop(6) = {2, 13, 17, 6, 7, -10, 14, 18, -12};
Plane Surface(6) = {6};
...
Color Brown{ Surface{1}; Surface{2}; Surface{3}; Surface{5}; }
