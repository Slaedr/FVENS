...
void EulerPhysics::evaluate_normal_flux(const a_real *const u, const a_real* const n, 
...
void EulerPhysics::evaluate_normal_jacobian(const a_real *const u, const a_real* const n, 
